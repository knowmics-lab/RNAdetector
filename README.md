...
This analysis allows the identification and quantification of ***circRNAs***. To start the analysis, **Run Analysis** on the dashboard and then **CircRNA Analysis**. After that, follow the indications step-by-step described on the interface to start the analysis. Four steps are required
