...
if [ $PAIRED ]; then
  perl CIRI.pl -I $INPUT_SAM_FILE -A $GTF_FILE -F $FASTA_FILE -M $SPANNING -o $OUTPUT -P
else
  perl CIRI.pl -I $INPUT_SAM_FILE -A $GTF_FILE -F $FASTA_FILE -M $SPANNING -o $OUTPUT -S
fi
